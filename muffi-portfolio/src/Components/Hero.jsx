      ...
      <Flex id="Home" w={{ base: "90vw", md: "95vw", lg: "85vw" }} alignItems="center" minH="90vh" m="auto">
          <Flex w="100%"direction={{base:"column",lg:"row"}} alignItems='center'>
              ...
              <Flex color="white" w={{base:"auto",lg:"60%"}} direction="column" justifyContent={'center'} gap=".5rem" alignItems={{base:"center",lg:"start"}}>
                  <Heading fontFamily={"cursive"} fontWeight="md" fontSize={{base:"3xl",sm:"3xl",md:"4xl",lg:"5xl"}}>Mufadal Sadriwala</Heading>
                  <Heading fontStyle={"italic"} fontFamily='cursive' fontWeight="md" color="#E6990B" fontSize={{base:"2xl",sm:"2xl",md:"3xl",lg:"4xl"}}>Full Stack Developer</Heading>
                  <Text fontSize={{base:"md",md:"lg",lg:"xl"}} fontStyle='italic' textAlign={{base:"center",lg:"left"}} color="gray" fontFamily={"cursive"}>A Software Developer with a passion for solving problems and learning new things.</Text>
