import { Box, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerOverlay, Flex, Heading, useDisclosure,Icon, Button } from '@chakra-ui/react'
  ...
  return (
      <Flex bgColor="hsl(219,48%,8%)" boxShadow="dark-lg" pos={"sticky"} top={0} zIndex={100} justifyContent='space-between' p="1.5rem" alignItems={"center"} color='white'> 
          ...
          <Box display={{base:"none",sm:"none",md:"block"}}>
              <Flex  gap='1rem' fontFamily={"cursive"} alignItems='center'>
          ...
          <Icon h="10" w={6} as={GiHamburgerMenu} display={{ base: "block", sm: "block", md: "none" }} onClick={onOpen}></Icon>
          ...
          >
              ...
              <DrawerContent>
                  ...
                  <DrawerBody className='drawer' style={{backgroundColor:"hsl(219,48%,8%)",color:"#77BEF8"}}>
                    <Flex gap='2rem' direction={"column"} alignItems="center" fontFamily={"cursive"} justifyContent={"center"} h='100vh'> 
