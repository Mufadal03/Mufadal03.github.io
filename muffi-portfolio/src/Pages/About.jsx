...
const About = () => {
  ...
  return (
      ...
      <Line />
      <Heading fontWeight={"md"}fontSize={{base:"2xl",md:"3xl",lg:"4xl"}}  fontFamily={"Unbounded"}>About Me</Heading>
